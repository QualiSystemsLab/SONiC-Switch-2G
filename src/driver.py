...
from cloudshell.shell.core.driver_context import InitCommandContext, ResourceCommandContext, AutoLoadResource, \
    AutoLoadAttribute, AutoLoadDetails, CancellationContext, ResourceContextDetails

from cloudshell.devices.driver_helper import get_logger_with_thread_id, get_api, get_cli
from cloudshell.shell.core.resource_driver_interface import ResourceDriverInterface

from discover.sonic_autoloader import SonicGenericSNMPDiscovery
from cloudshell.snmp.snmp_parameters import SNMPV2ReadParameters


class SonicswitchGen2Driver (ResourceDriverInterface):
    SUPPORTED_OS = [r'[Ss]onic']
    ...
    def get_inventory(self, context):
        ...
        response = SonicGenericSNMPDiscovery(snmp_params, self.SHELL_NAME, self.SHELL_TYPE, context.resource.name, logger).discover()
        return response

        #sonic_autoloader = SonicSwitchAutoloader(context=context)
        #return sonic_autoloader.autoload()
